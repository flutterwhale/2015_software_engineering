...
<form action="${pageContext.request.contextPath}/CourseController/insertCoursePage" method="get" >
 ...
 <form action="${pageContext.request.contextPath}/LoginController/main.do" method="get" >
	...
	if(myCourses.isEmpty()){
		...
		<table>
		<tr align="center">
		<td width="150"> 신청 강좌명</td>
		<td width="150"> 교수</td>
		<td width="150"> 학기</td>
		<td width="120"> 신청 학점</td>
		<td width="150"> 수강신청 삭제</td>
		</tr>
	<%
	for(Course c : myCourses){ %>
		...
		<input type="hidden" name="hackjeom" value=<%=c.getHackjeom()%>>
			...
			<tr align="center">
					...
					<td width="150">  <button class="btn_registForCourse" type="submit" >수강 삭제</button></td>
			</tr>
